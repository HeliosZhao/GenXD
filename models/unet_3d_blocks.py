...
from .transformers import TransformerSpatioTemporalModel, TransformerMVSpatioTemporalModel
from .resnet import MVSpatioTemporalResBlock
from .unet_4d_blocks import CrossAttnDownBlockMVSpatioTemporal, DownBlockMVSpatioTemporal, CrossAttnUpBlockMVSpatioTemporal, UpBlockMVSpatioTemporal
from .unet_4d_blocks import DownBlockMVCascadeTemporal, CrossAttnDownBlockMVCascadeTemporal, UpBlockMVCascadeTemporal, CrossAttnUpBlockMVCascadeTemporal, CrossAttnDownBlock2DCascade, CrossAttnUpBlock2DCascade
...
def get_down_block(
    ...
    elif down_block_type == "DownBlockMVSpatioTemporal":
        # added for SDV
        return DownBlockMVSpatioTemporal(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
    ...
    elif down_block_type == "DownBlockMVCascadeTemporal":
        # added for SDV
        return DownBlockMVCascadeTemporal(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
    ...
    elif down_block_type == "CrossAttnDownBlockMVSpatioTemporal":
        # added for MV-SVD
        return CrossAttnDownBlockMVSpatioTemporal(
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
            num_layers=num_layers,
    ...
    elif down_block_type == "CrossAttnDownBlockMVCascadeTemporal":
        # added for MV-SVD
        return CrossAttnDownBlockMVCascadeTemporal(
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
            num_layers=num_layers,
    ...
    elif down_block_type == "CrossAttnDownBlock2DCascade":
        # added for MV-SVD
        return CrossAttnDownBlock2DCascade(
            in_channels=in_channels,
            out_channels=out_channels,
            temb_channels=temb_channels,
            num_layers=num_layers,
...
def get_up_block(
    ...
    elif up_block_type == "UpBlockMVSpatioTemporal":
        # added for SDV
        return UpBlockMVSpatioTemporal(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
    ...
    elif up_block_type == "UpBlockMVCascadeTemporal":
        # added for SDV
        return UpBlockMVCascadeTemporal(
            num_layers=num_layers,
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
    ...
    elif up_block_type == "CrossAttnUpBlockMVSpatioTemporal":
        # added for SDV
        # if cross_attention_dim is None:
        #     raise ValueError("cross_attention_dim must be specified for CrossAttnUpBlockSpatioTemporal")
        return CrossAttnUpBlockMVSpatioTemporal(
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
            temb_channels=temb_channels,
    ...
    elif up_block_type == "CrossAttnUpBlockMVCascadeTemporal":
        # added for SDV
        # if cross_attention_dim is None:
        #     raise ValueError("cross_attention_dim must be specified for CrossAttnUpBlockSpatioTemporal")
        return CrossAttnUpBlockMVCascadeTemporal(
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
            temb_channels=temb_channels,
    ...
    elif up_block_type == "CrossAttnUpBlock2DCascade":
        # added for SDV
        # if cross_attention_dim is None:
        #     raise ValueError("cross_attention_dim must be specified for CrossAttnUpBlockSpatioTemporal")
        return CrossAttnUpBlock2DCascade(
            in_channels=in_channels,
            out_channels=out_channels,
            prev_output_channel=prev_output_channel,
            temb_channels=temb_channels,
